...
| `$03DC` | `u8` | 戦闘: 敵軍の友好度 |
| `$03DD` | | (未使用) |
| `$03DE` | `u8` | 戦闘前フェイズでの選択による性格変更フラグ (0:false, 1:true)<br>{% xxx() %}実質未使用{% end %}: [詳細](@/tips/unused-alignment-change/_index.md) |
...
| `$041F` | | (未使用) |
| `$0420-$042E` | `u8[15]` | 戦闘: 各敵がこのターンの行動を終えたかどうか (0:false, 1:true) |
| `$042F` | | (未使用) |
| `$0430` | | 雑用 |
| `$0431` | | {% todo() %}TODO{% end %} |
| `$0432` | `u8` | 戦闘: 敵前衛の個体数 |
...
| | | {% todo() %}TODO{% end %} |
| `$6880-$689F` | `u8[32]` | [踏破済みフラグ配列](@/data-structure/automap/_index.md): ソーピガルの町 |
