...
<use href="#svg-cell-4-6" x="165" y="330"><title>(4, 6) 第1の封印を解除</title></use>
...
<use href="#svg-cell-4-10" x="165" y="198"><title>(4, 10) 第2の封印を解除</title></use>
...
<use href="#svg-cell-6-7" x="231" y="297"><title>(6, 7) 西: ゲームクリアフラグが立つ</title></use>
...
<use href="#svg-cell-7-7" x="264" y="297"><title>(7, 7) 何も起きない (イベントフラグだけ設定されている)</title></use>
<a href="#event-7-8">
<use href="#svg-cell-7-8" x="264" y="264"><title>(7, 8) 南: ここがその場所である</title></use>
</a>
<use href="#svg-cell-7-9" x="264" y="231"><title>(7, 9) 何も起きない (イベントフラグだけ設定されている)</title></use>
<use href="#svg-cell-7-10" x="264" y="198"><title>(7, 10) 南: キーカードで開く扉</title></use>
...
<use href="#svg-cell-7-14" x="264" y="66"><title>(7, 14) 第3の封印を解除</title></use>
...
<use href="#svg-cell-10-6" x="363" y="330"><title>(10, 6) 第5の封印を解除</title></use>
...
<use href="#svg-cell-10-10" x="363" y="198"><title>(10, 10) 第4の封印を解除</title></use>
...
### (7, 8) 南: ここがその場所である {#event-7-8}

以下のいずれかの条件を満たす場合、「お前たちはまだ使命を果たしていない」でソーピガルの町 (8, 5) へ飛ばされる:

* 既に世界の果てからエンディングに行ける状態である
* イドの迷宮をクリアしていない

そうでない場合、(7, 7) へ進むためのヒントが表示される。

このマスで探索メニューコマンド「やすむ」を実行すると (7, 7) へワープする。

{% xxx() %}実はこのイベントは回避できる。{% end %}発生条件が「南向き」なので、キーカードの扉を開けて (7, 9) に入ったら北へ方向変換し、後退移動でこのマスに来ればイベントは起こらず、そのまま「やすむ」を実行すれば (7, 7) へワープできる。つまり、{% xxx() %}実はイドの迷宮に行かなくてもゲームクリアは可能。{% end %}
